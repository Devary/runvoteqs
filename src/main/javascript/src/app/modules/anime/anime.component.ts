...
import {CustomCallParams} from "../../context/models/CustomCallParams";
...
export class AnimeComponent {
  ...
  constructor(private contextService:ContextService) {
    ...
    //let params= new Map();
    //params.set("attr","id")
    //let customCall = new CustomCallParams(SHARS_NOT_RELATED_TO_ANIME,params)
    var sharacters: TableField = new TableField("sharacters", TableFieldType.MULTI_SELECT, "sharacter", [],new CustomCallParams());
